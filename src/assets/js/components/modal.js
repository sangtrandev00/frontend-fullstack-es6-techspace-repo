export const getModalComponent = () => {
  return `
        <button id="toggleModalBtn" data-modal-target="popup-modal" data-modal-toggle="popup-modal"
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <div id="modalIcon" class="my-3">

                    </div>

                    <h3 id="modalTitle" class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you
                        sure
                        you want to
