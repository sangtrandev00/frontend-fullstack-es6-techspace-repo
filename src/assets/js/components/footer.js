    ...
    <div class="mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4 text-yellow-50 relative ">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
            <div class="flex flex-col flex-shrink-0">
                ...
                <p class="text-sm leading-none text-gray-800 mt-4 dark:text-white">Located at Di An, Binh Duong</p>
                <p class="text-sm leading-none text-gray-800 mt-4 dark:text-white">Phone: 0937988510</p>
                <p class="text-sm leading-none text-gray-800 mt-4 dark:text-white">Email: nhatsang0101@gmail.com</p>
            ...
            <div class="mt-10 lg:block hidden">
                ...
                <div
                    ...
                    <button aria-label="send"
                        ...
                        <svg class="dark:text-white dark:hover:text-gray-200" width="16" height="17"
